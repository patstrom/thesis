\begin{abstract}
	...
	handful lines of code, and for manner of diversity 82\% of gadgets only appeared in one
	version, and the most frequent gadget only appeared in 23\% of versions. However, since
	Unison does not yet support x86 future work is required before anything practical can be
	evaluated.
