...
In other words, we want the \texti{rdi} register to point to the "/bin/cat flag.txt" string
...
Appendix \reg{appendix:rop-exploit} contains the source code of a python script that
...
% TODO: Explain how diversity and ROP relates to each other.
