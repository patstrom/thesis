...
%\subsection{Software Diversity for Security Purposes}
%
%As mentioned, software diversity has uses in the computer security field. There are a wide
%range of techniques to exploit binary executable files. From decompiling with intent to
%
%
