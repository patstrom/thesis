...
\lstinputlisting[label={src:gcc-vec-add},caption=Assembly emitted by gcc for listing \ref{src:vec-add},tabsize=2,
frame=single, breaklines=true,showstringspaces=false,backgroundcolor=\color{lightgray},language={[x86masm]Assembler}]
{background/software-diversity/examples/gcc_vec_add.s}

\lstinputlisting[label={src:clang-vec-add},caption=Assembly emitted by clang for listing \ref{src:vec-add},tabsize=2,
frame=single, breaklines=true,showstringspaces=false,backgroundcolor=\color{lightgray},language={[x86masm]Assembler}]
...
\lstinputlisting[label={src:clang-gadget},caption=Gadgets present in the assembly emitted by
clang (see listing \ref{src:clang-vec-add}),tabsize=2, frame=single, breaklines=true,
showstringspaces=false,backgroundcolor=\color{lightgray}]
...
\lstinputlisting[label={src:gcc-gadget},caption=Gadgets present in the assembly emitted by
gcc (see listing \ref{src:gcc-vec-add}),tabsize=2, frame=single,showstringspaces=false,
backgroundcolor=\color{lightgray},language={[x86masm]Assembler}]
...
\lstinputlisting[label={src:gcc-gadget},caption=Intended instruction sequence,tabsize=2,
frame=single, breaklines=true,showstringspaces=false,backgroundcolor=\color{lightgray},language={[x86masm]Assembler}]
