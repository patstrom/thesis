...
Henceforth two integers separated by two dots will indicate a range of all integers between
...
The first step of finding the optimal solution is identify what constitutes as \textit{
