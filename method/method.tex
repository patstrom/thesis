...
\section{The Gecode Constraint Solver}
...
breaking gadgets is about shifting, adding or removing \textit{any} instruction in the
program, and since the diversification strategies are applied globally they are supposedly
equally effective regardless of the placement or structure of the instruction.
