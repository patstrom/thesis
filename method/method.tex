...
will then be combined to yield 1000 different program versions for each combination, at
a total of 12000 program versions (and a total of 276000 different function versions).
...
and each version consists of 23 functions. The result will emphasize comparison between
the sampling rates for each strategy as well as the difference between the strategies.
